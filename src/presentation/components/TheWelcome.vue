<script setup lang="ts">
  import WelcomeItem from '@/presentation/components/WelcomeItem.vue';
  import DocumentationIcon from '@/presentation/components/icons/IconDocumentation.vue';
  import ToolingIcon from '@/presentation/components/icons/IconTooling.vue';
  import EcosystemIcon from '@/presentation/components/icons/IconEcosystem.vue';
  import CommunityIcon from '@/presentation/components/icons/IconCommunity.vue';
  import SupportIcon from '@/presentation/components/icons/IconSupport.vue';
</script>
